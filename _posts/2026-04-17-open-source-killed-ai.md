...
Cal.com was forced into this move because the cost of creating a pull request has become so much lower than the cost of reviewing one, so [any person with a laptop and a $20/month subscription](/blog/ai-illiterate-programmers){:target="blank"} thinks that they can open a pull request and waste time for senior engineers.
...
That might be uncomfortable to hear if you are a SaaS company. Your customers want your domain model and your reliability, but they are [not going to accept the same old trite UI anymore.](/blog/ai-killing-b2b-saas){:target="_blank"}

You have, optimistically, maybe 12 months before your customers start asking if they can build on top of you - if they aren't already.

Open source is dead, and [closed off traditional SaaS isn't meeting the bar](https://gigacatalyst.com/blog/three-levels-of-adding-ai-to-your-saas){:target="_blank"} for customers of the future.
