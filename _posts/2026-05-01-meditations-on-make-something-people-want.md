...
<figure>
  <img src="{{ '/assets/make-something-people-want/namanyay-shm-simulator.gif' | relative_url }}" alt="Namanyay Goel's SHM Simulator">
  <figcaption>Play with some of my oldest code, <a href="https://nmn.gl/SHM-simulator/" target="_blank">my Physics Simple Harmonic Motion Simulator</a></figcaption>
</figure>

Around the same time, I discovered [Hacker News](https://news.ycombinator.com/), the orange site that still takes up hours every day.
...
<figure>
  <img src="{{ '/assets/make-something-people-want/pg-first-article.png' | relative_url }}" alt="PG's Startup = Growth">
  <figcaption><a href="https://www.paulgraham.com/growth.html">Startup = Growth</a> by PG, the advice still is evergreen!</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/make-something-people-want/namanyay-wordpress-theme-seller.png' | relative_url }}" alt="Namanyay Goel's Online WordPress Theme Businesses">
  <figcaption>I was working hours after school just for $40 :)</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/make-something-people-want/namanyay-tldr-tech.png' | relative_url }}" alt="Namanyay Goel's early tech blog TLDR;Tech">
  <figcaption>News of Jun 5, 2014. Preserved forever thanks to the <a href="https://archive.is/fkM3p" target="_blank">Archive.is</a></figcaption>
</figure>

It didn't work because we didn't make what _people wanted_. We made what _we_ thought could be a cool idea. We didn't take the time to estimate how many people want to read tech news site (demand) or how many tech news sites existed already (supply).
...
And you've tried enough of those offline and online, you start to get an idea of what people are thinking about. You tap into the _zeitgest_, and you start acquiring _taste_, you you start to feel that you _do_ know what people might want!
...
Over a series of three pivots, six product launches, 20,000 people served, I'm fortunate to [finally build a product](https://gigacatalyst.com/) that seems to be what people want. A Series B CEO told me that this is the biggest release in his company's history.
...
[^1]: To not do exactly that is why I've always installed an ad blocker.

[^2]: If you're in San Francisco, then you see that most business don't care about saving money, they just want to save time and make more money.